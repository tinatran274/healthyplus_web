                ...
                <Col span={5}>
                    {currentUser ? ( 
                        <div className={styles.info}>
                            ...
                            <span onClick={handleDetailUser}>Cá nhân</span>
                            <Popconfirm
                                title="Đăng xuất"
                                ...
                                cancelText="Hủy bỏ"
                            >
                                <div className={styles.signout}><span>Đăng xuất</span></div>
                            </Popconfirm>
                            
                        </div> ) : (
                        <div className={styles.info}>
                            <div><UserOutlined className={styles.user_icon}/></div>
                            <div onClick={handleSignin} className={styles.signin}><span>Đăng nhập</span></div>
                        </div>
                    )}
