...
import CardTechnologyProductComponent from "../CardTechnologyProductComponent/CardTechnologyProductComponent.jsx";
...
const ListTechnologyProductComponent = () => {
    ...
    const getListProduct = async () => {
        setListProduct( await TechnologyProductService.getAllTechnologyProduct());
    }
    const handleAuth = () => {
        ...
        <div>
            <div className={styles.wrap}>
                <div className={styles.list}>
                    ...
                    .map((product) => {
                        return (
                            <CardTechnologyProductComponent
                                key={product.getId()}
                                id={product.getId()}
...
export default ListTechnologyProductComponent