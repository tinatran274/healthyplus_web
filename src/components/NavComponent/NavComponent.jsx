      ...
      <div className={styles.topnav} id="myTopnav">
        <div className={styles.nores}>
          ...
          <div className={styles.dropdown}>
            <WrapperDropButton className={styles.dropbtn}>
              Kiểm soát
              <CaretDownOutlined className={styles.icon} />
            </WrapperDropButton>
            <WrapperDropContent className={styles.dropdown_content}>
              <WrapperLink onClick={handleControlCalories}>
                <CaretRightOutlined className={styles.icon} />
                Calories
              </WrapperLink>
              <WrapperLink onClick={handleControlWater}>
                <CaretRightOutlined className={styles.icon} />
                Nước
              </WrapperLink>
            </WrapperDropContent>
          ...
          <div className={styles.dropdown}>
            ...
            <WrapperDropContent className={styles.dropdown_content}>
              <WrapperLink onClick={handleDishPage}>
                <CaretRightOutlined className={styles.icon} />
                Món ăn
              </WrapperLink>
              <WrapperLink onClick={handleIngredientPage}>
                <CaretRightOutlined className={styles.icon} />
                Nguyên liệu
              </WrapperLink>
            </WrapperDropContent>
          ...
          <WrapperLink>Đề Xuất</WrapperLink>
          <div className={styles.dropdown}>
            <WrapperDropButton className={styles.dropbtn}>
              Sản phẩm
              <CaretDownOutlined className={styles.icon} />
            ...
            <WrapperDropContent className={styles.dropdown_content}>
              <WrapperLink onClick={handleProductPage}>
                <CaretRightOutlined className={styles.icon} />
                Thực phẩm
              </WrapperLink>
              <WrapperLink onClick={handleTechnologyProductPage}>
                <CaretRightOutlined className={styles.icon} />
                Đồ công nghệ
              </WrapperLink>
            </WrapperDropContent>
        ...
        <div className={styles.res} style={{ width: 256 }}>
          ...
          {collapsed ? (
            <div className={styles.navres} style={{ display: "block" }}>
              <div className={styles.btn} onClick={handleHome}>
                Trang Chủ
              </div>
              <div className={styles.drop}>
                ...
                <div className={styles.content}>
                  <div className={styles.link} onClick={handleControlCalories}>
                    <CaretRightOutlined className={styles.icon} />
                    Calories
                  </div>
                  <div className={styles.link} onClick={handleControlWater}>
                    <CaretRightOutlined className={styles.icon} />
                    Nước
                  </div>
                </div>
              ...
              <div className={styles.drop}>
                ...
                <div className={styles.content}>
                  <div className={styles.link} onClick={handleDishPage}>
                    <CaretRightOutlined className={styles.icon} />
                    Món ăn
                  </div>
                  <div className={styles.link} onClick={handleIngredientPage}>
                    <CaretRightOutlined className={styles.icon} />
                    Nguyên liệu
                  </div>
                </div>
              </div>
              <div className={styles.link} onClick={handleSuggestDishPage}>
                Gợi ý món
              </div>
              <div className={styles.link} onClick={handleExercisePage}>
                Vận động
              </div>
              ...
              <div className={styles.drop}>
                ...
                <div className={styles.content}>
                  <div className={styles.link} onClick={handleProductPage}>
                    <CaretRightOutlined className={styles.icon} />
                    Thực phẩm
                  </div>
                  <div
                    className={styles.link}
                    onClick={handleTechnologyProductPage}
                  >
                    <CaretRightOutlined className={styles.icon} />
                    Đồ công nghệ
                  </div>
